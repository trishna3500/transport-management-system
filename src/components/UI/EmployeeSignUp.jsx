...
const EmployeeSignUp = () => {
  ...
  return (
    <div className="flex">
      <img
        src="https://images.unsplash.com/photo-1623662346448-4fd13f54ffd0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80"
        alt=""
        className="w-5/12 h-screen"
      />
